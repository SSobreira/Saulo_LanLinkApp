...
export class DepartmentServiceProxy {
     ...
     * @return Success
     */
    createOne(name: string): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/Department/CreateOne?";
        if (name !== undefined)
    ...
    protected processCreateOne(response: Response): Observable<void> {
        const status = response.status;
        ...
        return this.http.request(url_, options_).flatMap((response_ : any) => {
            ...
            if (response_ instanceof Response) {
                try {
                    ...
                    return <Observable<DepartmentDTO>><any>Observable.throw(e);
                }
            } else
                return <Observable<DepartmentDTO>><any>Observable.throw(response_);
        });
    }

    protected processGet(response: Response): Observable<DepartmentDTO> {
        const status = response.status;
        ...
        return Observable.of<DepartmentDTO>(<any>null);
    }
     ...
     * @return Success
     */
    getAll(sorting: string, skipCount: number, maxResultCount: number): Observable<PagedResultDtoOfDepartmentDTO> {
        ...
        return this.http.request(url_, options_).flatMap((response_ : any) => {
            ...
            if (response_ instanceof Response) {
                try {
                    ...
                    return <Observable<PagedResultDtoOfDepartmentDTO>><any>Observable.throw(e);
                }
            } else
                return <Observable<PagedResultDtoOfDepartmentDTO>><any>Observable.throw(response_);
        });
    }

    protected processGetAll(response: Response): Observable<PagedResultDtoOfDepartmentDTO> {
        const status = response.status;
        ...
        return Observable.of<PagedResultDtoOfDepartmentDTO>(<any>null);
    }
     ...
     * @return Success
     */
    create(input: DepartmentDTO): Observable<DepartmentDTO> {
    ...
    protected processCreate(response: Response): Observable<DepartmentDTO> {
        const status = response.status;
     ...
     * @return Success
     */
    update(input: DepartmentDTO): Observable<DepartmentDTO> {
    ...
    protected processUpdate(response: Response): Observable<DepartmentDTO> {
        const status = response.status;
...
export class TransactionServiceProxy {
     ...
     * @return Success
     */
    createOne(userid: number, description: string, value: number, departid: number): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/Transaction/CreateOne?";
        ...
        if (departid === undefined || departid === null)
            throw new Error("The parameter 'departid' must be defined and cannot be null.");
        else
            url_ += "departid=" + encodeURIComponent("" + departid) + "&"; 
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processGet(response: Response): Observable<TransactionDTO> {
        const status = response.status;
     ...
     * @return Success
     */
    getAll(sorting: string, skipCount: number, maxResultCount: number): Observable<PagedResultDtoOfTransactionDTO> {
    ...
    protected processGetAll(response: Response): Observable<PagedResultDtoOfTransactionDTO> {
        const status = response.status;
     ...
     * @return Success
     */
    create(input: TransactionDTO): Observable<TransactionDTO> {
    ...
    protected processCreate(response: Response): Observable<TransactionDTO> {
        const status = response.status;
     ...
     * @return Success
     */
    update(input: TransactionDTO): Observable<TransactionDTO> {
    ...
    protected processUpdate(response: Response): Observable<TransactionDTO> {
        const status = response.status;
...
@Injectable()
export class UserDepartmentServiceProxy {
    private http: Http;
    private baseUrl: string;
    protected jsonParseReviver: (key: string, value: any) => any = undefined;
     ...
     * @return Success
     */
    createOne(userid: number, depid: number): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/UserDepartment/CreateOne?";
        if (userid === undefined || userid === null)
            throw new Error("The parameter 'userid' must be defined and cannot be null.");
        else
            url_ += "userid=" + encodeURIComponent("" + userid) + "&"; 
        if (depid === undefined || depid === null)
            throw new Error("The parameter 'depid' must be defined and cannot be null.");
        else
     ...
     * @return Success
     */
    get(id: number): Observable<UserDepartmentDTO> {
        let url_ = this.baseUrl + "/api/services/app/UserDepartment/Get?";
        if (id === undefined || id === null)
            throw new Error("The parameter 'id' must be defined and cannot be null.");
        else
            url_ += "Id=" + encodeURIComponent("" + id) + "&"; 
        ...
        return this.http.request(url_, options_).flatMap((response_ : any) => {
            ...
            if (response_ instanceof Response) {
                try {
                    ...
                    return <Observable<UserDepartmentDTO>><any>Observable.throw(e);
                }
            } else
                return <Observable<UserDepartmentDTO>><any>Observable.throw(response_);
        });
    }

    protected processGet(response: Response): Observable<UserDepartmentDTO> {
        const status = response.status;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = resultData200 ? UserDepartmentDTO.fromJS(resultData200) : new UserDepartmentDTO();
            return Observable.of(result200);
        } else if (status !== 200 && status !== 204) {
            const _responseText = response.text();
            return throwException("An unexpected server error occurred.", status, _responseText, _headers);
        }
        return Observable.of<UserDepartmentDTO>(<any>null);
    }
     ...
     * @return Success
     */
    getAll(sorting: string, skipCount: number, maxResultCount: number): Observable<PagedResultDtoOfUserDepartmentDTO> {
        let url_ = this.baseUrl + "/api/services/app/UserDepartment/GetAll?";
        if (sorting !== undefined)
            url_ += "Sorting=" + encodeURIComponent("" + sorting) + "&"; 
        if (skipCount === undefined || skipCount === null)
            throw new Error("The parameter 'skipCount' must be defined and cannot be null.");
        ...
        return this.http.request(url_, options_).flatMap((response_ : any) => {
            ...
            if (response_ instanceof Response) {
                try {
                    ...
                    return <Observable<PagedResultDtoOfUserDepartmentDTO>><any>Observable.throw(e);
                }
            } else
                return <Observable<PagedResultDtoOfUserDepartmentDTO>><any>Observable.throw(response_);
        });
    }

    protected processGetAll(response: Response): Observable<PagedResultDtoOfUserDepartmentDTO> {
        const status = response.status;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = resultData200 ? PagedResultDtoOfUserDepartmentDTO.fromJS(resultData200) : new PagedResultDtoOfUserDepartmentDTO();
            return Observable.of(result200);
        } else if (status !== 200 && status !== 204) {
            const _responseText = response.text();
            return throwException("An unexpected server error occurred.", status, _responseText, _headers);
        }
        return Observable.of<PagedResultDtoOfUserDepartmentDTO>(<any>null);
    }
     ...
     * @return Success
     */
    create(input: UserDepartmentDTO): Observable<UserDepartmentDTO> {
        let url_ = this.baseUrl + "/api/services/app/UserDepartment/Create";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processCreate(response: Response): Observable<UserDepartmentDTO> {
        const status = response.status;
     ...
     * @return Success
     */
    update(input: UserDepartmentDTO): Observable<UserDepartmentDTO> {
        let url_ = this.baseUrl + "/api/services/app/UserDepartment/Update";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processUpdate(response: Response): Observable<UserDepartmentDTO> {
        const status = response.status;
     ...
     */
    delete(id: number): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/UserDepartment/Delete?";
        if (id === undefined || id === null)
            throw new Error("The parameter 'id' must be defined and cannot be null.");
        else
            url_ += "Id=" + encodeURIComponent("" + id) + "&"; 
...
export class TransactionDTO implements ITransactionDTO {
    ...
    userCreator: UserDto;
    departmentCreatorId: number;
    departmentCreator: DepartmentDTO;
    creationTime: moment.Moment;
    id: number;
    ...
    init(data?: any) {
        if (data) {
            ...
            this.userCreatorId = data["userCreatorId"];
            this.userCreator = data["userCreator"] ? UserDto.fromJS(data["userCreator"]) : <any>undefined;
            this.departmentCreatorId = data["departmentCreatorId"];
            this.departmentCreator = data["departmentCreator"] ? DepartmentDTO.fromJS(data["departmentCreator"]) : <any>undefined;
            this.creationTime = data["creationTime"] ? moment(data["creationTime"].toString()) : <any>undefined;
            this.id = data["id"];
        }
    }
    ...
    toJSON(data?: any) {
        ...
        data["userCreator"] = this.userCreator ? this.userCreator.toJSON() : <any>undefined;
        data["departmentCreatorId"] = this.departmentCreatorId;
        data["departmentCreator"] = this.departmentCreator ? this.departmentCreator.toJSON() : <any>undefined;
        data["creationTime"] = this.creationTime ? this.creationTime.toISOString() : <any>undefined;
        data["id"] = this.id;
        return data; 
    }
...
export class CreateUserDto implements ICreateUserDto {
    ...
    init(data?: any) {
        if (data) {
            ...
            if (data["departmentNames"] && data["departmentNames"].constructor === Array) {
                this.departmentNames = [];
                for (let item of data["departmentNames"])
                    this.departmentNames.push(item);
            }
            this.password = data["password"];
        }
    }
    ...
    toJSON(data?: any) {
        ...
        if (this.departmentNames && this.departmentNames.constructor === Array) {
            data["departmentNames"] = [];
            for (let item of this.departmentNames)
                data["departmentNames"].push(item);
        }
        data["password"] = this.password;
        return data; 
    }
...
export class UserDepartmentDTO implements IUserDepartmentDTO {
    refDepartmentID: number;
    refUserID: number;
    refDepartment: DepartmentDTO;
    refUser: UserDto;
    id: number;

    constructor(data?: IUserDepartmentDTO) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(data?: any) {
        if (data) {
            this.refDepartmentID = data["refDepartmentID"];
            this.refUserID = data["refUserID"];
            this.refDepartment = data["refDepartment"] ? DepartmentDTO.fromJS(data["refDepartment"]) : <any>undefined;
            this.refUser = data["refUser"] ? UserDto.fromJS(data["refUser"]) : <any>undefined;
            this.id = data["id"];
        }
    }

    static fromJS(data: any): UserDepartmentDTO {
        let result = new UserDepartmentDTO();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        data = typeof data === 'object' ? data : {};
        data["refDepartmentID"] = this.refDepartmentID;
        data["refUserID"] = this.refUserID;
        data["refDepartment"] = this.refDepartment ? this.refDepartment.toJSON() : <any>undefined;
        data["refUser"] = this.refUser ? this.refUser.toJSON() : <any>undefined;
        data["id"] = this.id;
        return data; 
    }
...
export interface IUserDepartmentDTO {
    refDepartmentID: number;
    refUserID: number;
    refDepartment: DepartmentDTO;
    refUser: UserDto;
...
export class PagedResultDtoOfUserDepartmentDTO implements IPagedResultDtoOfUserDepartmentDTO {
    totalCount: number;
    items: UserDepartmentDTO[];

    constructor(data?: IPagedResultDtoOfUserDepartmentDTO) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(data?: any) {
        if (data) {
            ...
            if (data["items"] && data["items"].constructor === Array) {
                this.items = [];
                for (let item of data["items"])
                    this.items.push(UserDepartmentDTO.fromJS(item));
            }
        }
    }

    static fromJS(data: any): PagedResultDtoOfUserDepartmentDTO {
        let result = new PagedResultDtoOfUserDepartmentDTO();
        result.init(data);
        return result;
    }
...
export interface IPagedResultDtoOfUserDepartmentDTO {
    totalCount: number;
    items: UserDepartmentDTO[];
}
